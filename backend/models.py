...
class LiveAnalysisReferenceResponse(BaseModel):
	...
	authority_section_number: str | None = None
	authority_section_text: str | None = None
...
class CaseReaderCitationResponse(BaseModel):
	...
	section_number: str | None = None
	provision_text: str | None = None
	provision_section: str | None = None
	provision_subsection: str | None = None
	provision_paragraph: str | None = None
	provision_nested_depth: int | None = None
	provision_is_range_or_list: bool | None = None
