...
## 356:1 · paragraphs 0-30

- Citations: `{}`
- Statutes: `{}`
- Tags: `{}`
- Source hash: `ce45447888338a457d998e7cacdc9e16ba147d3eb68fae948bcee2dfd3f99df4`

### Deterministic evidence spans

These are finer rule-based clusters inside the broader deterministic unit. Their explanations describe detected cues and roles; they are not model-generated conclusions.

#### 356:1:subtheme:1 · paragraphs 0-1

- Raw key terms: `applicant, decision, immigration, jamil, sadat, bangladesh, board, bogus`
- Display key terms: `jamil, sadat, bangladesh, bogus`
- Argument roles: `governing_rule`
- Explanation: Observed roles: governing_rule Display terms: jamil, sadat, bangladesh, bogus Rule/authority context: [1] Sadat Jamil, a citizen of Bangladesh, challenges the September 30, 2005 decision of the Refugee Protection Division (the tribunal) rejecting his claim for protection pursuant to sections 96 and 97 of the Immigration  Evidence spans paragraphs 0-1. This is a deterministic evidence summary, not a legal conclusion.
- Evidence: `governing_rule` cue `pursuant to` at chunk `4094403` offsets `170-181`; context: [1] Sadat Jamil, a citizen of Bangladesh, challenges the September 30, 2005 decision of the Refugee Protection Division (the tribunal) rejecting his claim for protection pursuant to sections 96 and 97 of the Immigration and Refugee Protection Act (the Act).

#### 356:1:subtheme:2 · paragraphs 2-10

- Raw key terms: `tribunal, league, awami, contradictions, student, applicant's, claim, claimant`
- Display key terms: `league, awami, contradictions, student, applicant's`
- Argument roles: `evidence_fact, governing_rule, issue`
- Explanation: Observed roles: evidence_fact, governing_rule, issue Display terms: league, awami, contradictions, student, applicant's Rule/authority context: a decision made on a finding of fact arrived at in a perverse or capricious manner or without regard for the material before it, a standard equivalent to the standard of review of patent unreasonableness meaning clear ir Evidence spans paragraphs 2-10. This is a deterministic evidence summary, not a legal conclusion.
- Evidence: `issue` cue `issue` at chunk `4094404` offsets `13-18`; context: [2] The sole issue in this judicial review proceeding is whether the credibility findings made by the tribunal, being findings of fact, constituted a decision made within the terms of section 18.
- Evidence: `governing_rule` cue `standard of review` at chunk `4094404` offsets `397-415`; context: a decision made on a finding of fact arrived at in a perverse or capricious manner or without regard for the material before it, a standard equivalent to the standard of review of patent unreasonableness meaning clear irrationality, see Law Society of New Brunswick v.
- Evidence: `evidence_fact` cue `testimony` at chunk `4094407` offsets `124-133`; context: Contradictions when holding the position of Publicity Secretary
· His testimony: June 1998 to July 1999;
· His PIF: June 1998 when he was elected;
· His Schedule I: December 1997 to June 1999.
- Evidence: `evidence_fact` cue `testimony` at chunk `4094409` offsets `161-170`; context: [7] After citing some decisions of the Federal Court stating the tribunal is entitled to rely on contradictions between point of entry notes (POE) and the later testimony the tribunal wrote "the initial declarations of an asylum-seeker are of greater importance, since they take place before he had the opportunity to fabricate a story to support his claim.
- Evidence: `evidence_fact` cue `testimony` at chunk `4094410` offsets `49-58`; context: [8] The tribunal also focused on the applicant's testimony concerning his detention by the police from April 29, 2004 until May 2, 2004 with other Awami League members as they attempted to join a rally in Dhaka.

#### 356:1:subtheme:3 · paragraphs 11-12

- Raw key terms: `applicant, april, asked, august, claimant, first, previous, tribunal`
- Display key terms: `april, asked, august, first, previous`
- Argument roles: `evidence_fact, issue, reasoning_application`
- Explanation: Observed roles: evidence_fact, issue, reasoning_application Display terms: april, asked, august, first, previous Application context: For the above reasons, the tribunal concludes that the claimant was not arrested by the police, contrary to his allegations. | According to the tribunal, the applicant explained it was because during this incident for the first time Monir Hajee and the BNP goons threatened to kill him. Evidence spans paragraphs 11-12. This is a deterministic evidence summary, not a legal conclusion.
- Evidence: `issue` cue `question` at chunk `4094413` offsets `345-353`; context: The tribunal noted "it is only after the Presiding Member repeated the question that the claimant realised he was in trouble.
- Evidence: `evidence_fact` cue `testimony` at chunk `4094413` offsets `61-70`; context: [11] The tribunal described another facet of the applicant's testimony regarding his arrest in April, 2004.
- Evidence: `reasoning_application` cue `concludes` at chunk `4094413` offsets `610-619`; context: For the above reasons, the tribunal concludes that the claimant was not arrested by the police, contrary to his allegations.
- Evidence: `reasoning_application` cue `because` at chunk `4094414` offsets `219-226`; context: According to the tribunal, the applicant explained it was because during this incident for the first time Monir Hajee and the BNP goons threatened to kill him.

#### 356:1:subtheme:4 · paragraphs 13-20

- Raw key terms: `court, fact, tribunal, canada, decision, findings, review, board`
- Display key terms: `fact, findings, review`
- Argument roles: `evidence_fact, governing_rule, issue`
- Explanation: Observed roles: evidence_fact, governing_rule, issue Display terms: fact, findings, review Rule/authority context: [15] Both counsel agree on the governing standard of review since credibility findings are findings of fact which draw the most deference from the Court. | 1(4)(d) enables the Court to set aside a tribunal decision where the decision is based on an erroneous finding of fact it made in a perverse or capricious manner or without regard for the material before it which is a st Evidence spans paragraphs 13-20. This is a deterministic evidence summary, not a legal conclusion.
- Evidence: `issue` cue `issue` at chunk `4094415` offsets `410-415`; context: He could not furnish a reasonable explanation on this issue.
- Evidence: `issue` cue `issue` at chunk `4094416` offsets `694-699`; context: This is a serious issue.
- Evidence: `governing_rule` cue `standard of review` at chunk `4094417` offsets `41-59`; context: [15] Both counsel agree on the governing standard of review since credibility findings are findings of fact which draw the most deference from the Court.
- Evidence: `governing_rule` cue `standard of review` at chunk `4094418` offsets `234-252`; context: 1(4)(d) enables the Court to set aside a tribunal decision where the decision is based on an erroneous finding of fact it made in a perverse or capricious manner or without regard for the material before it which is a standard of review analogous to patent unreasonableness.
- Evidence: `evidence_fact` cue `testimony` at chunk `4094420` offsets `366-375`; context: 315 at paragraph 4 where Justice Décary expresses himself as follows:
¶ 4 There is no longer any doubt that the Refugee Division, which is a specialized tribunal, has complete jurisdiction to determine the plausibility of testimony: who is in a better position than the Refugee Division to gauge the credibility of an account and to draw the necessary inferences?
- Evidence: `evidence_fact` cue `evidence` at chunk `4094421` offsets `503-511`; context: Courts must not revisit the facts or weigh the evidence.
- Evidence: `governing_rule` cue `standard of review` at chunk `4094421` offsets `248-266`; context: 793 at paragraph 85 where Justice L'Heureux-Dubé writes the following:
¶ 85 We must remember that the standard of review on the factual findings of an administrative tribunal is an extremely deferent one: Ross v.

#### 356:1:subtheme:5 · paragraphs 21-24

- Raw key terms: `evidence, applicant, allegedly, aman, because, counsel, decision, degree`
- Display key terms: `allegedly, aman, because, degree`
- Argument roles: `disposition, evidence_fact, governing_rule, issue, party_position, reasoning_application`
- Explanation: Observed roles: disposition, evidence_fact, governing_rule, issue, party_position, reasoning_application Display terms: allegedly, aman, because, degree Position/evidence statements: She argues the tribunal misread the evidence when it drew contradictions between the applicant's testimony, his PIF and his Schedule I of the POE. Rule/authority context: His lawyer did write "Per the order of Minister Aman Ullah Aman, they want to question Sadat Jamil" a detention which is possible under the Special Powers Act. Application context: His explanation is at Certified Tribunal Record (CTR) page 182 where he testified that in October 2000 he was an ordinary member without holding any position because he was not studying at that time but continued his stu | [23] Notwithstanding the high degree on deference which must be accorded to the credibility findings of the tribunal, after reflecting upon the tribunal's decision, the transcript of evidence and the arguments of counsel Operative outcome context: [23] Notwithstanding the high degree on deference which must be accorded to the credibility findings of the tribunal, after reflecting upon the tribunal's decision, the transcript of evidence and the arguments of counsel Evidence spans paragraphs 21-24. This is a deterministic evidence summary, not a legal conclusion.
- Evidence: `issue` cue `issue` at chunk `4094423` offsets `3526-3531`; context: The tribunal concluded he could not furnish a reasonable explanation on the issue.
- Evidence: `party_position` cue `argues` at chunk `4094423` offsets `110-116`; context: She argues the tribunal misread the evidence when it drew contradictions between the applicant's testimony, his PIF and his Schedule I of the POE.
- Evidence: `evidence_fact` cue `evidence` at chunk `4094423` offsets `142-150`; context: She argues the tribunal misread the evidence when it drew contradictions between the applicant's testimony, his PIF and his Schedule I of the POE.
- Evidence: `governing_rule` cue `under` at chunk `4094423` offsets `4062-4067`; context: His lawyer did write "Per the order of Minister Aman Ullah Aman, they want to question Sadat Jamil" a detention which is possible under the Special Powers Act.
- Evidence: `reasoning_application` cue `because` at chunk `4094423` offsets `1029-1036`; context: His explanation is at Certified Tribunal Record (CTR) page 182 where he testified that in October 2000 he was an ordinary member without holding any position because he was not studying at that time but continued his studies in September 2001 when he began pursuing his Bachelor of Commerce Degree.
- Evidence: `evidence_fact` cue `evidence` at chunk `4094424` offsets `23-31`; context: [22] I should note the evidence is Mr.
- Evidence: `evidence_fact` cue `evidence` at chunk `4094425` offsets `183-191`; context: [23] Notwithstanding the high degree on deference which must be accorded to the credibility findings of the tribunal, after reflecting upon the tribunal's decision, the transcript of evidence and the arguments of counsel, I have come to the conclusion this judicial review application must be allowed because no amount of curial deference can justify letting the tribunal's decision stand.
- Evidence: `reasoning_application` cue `because` at chunk `4094425` offsets `301-308`; context: [23] Notwithstanding the high degree on deference which must be accorded to the credibility findings of the tribunal, after reflecting upon the tribunal's decision, the transcript of evidence and the arguments of counsel, I have come to the conclusion this judicial review application must be allowed because no amount of curial deference can justify letting the tribunal's decision stand.
- Evidence: `disposition` cue `allowed` at chunk `4094425` offsets `293-300`; context: [23] Notwithstanding the high degree on deference which must be accorded to the credibility findings of the tribunal, after reflecting upon the tribunal's decision, the transcript of evidence and the arguments of counsel, I have come to the conclusion this judicial review application must be allowed because no amount of curial deference can justify letting the tribunal's decision stand.
- Evidence: `evidence_fact` cue `evidence` at chunk `4094426` offsets `378-386`; context: Canada (Minister of Citizenship and Immigration) 2003 FCT 116 that a Refugee Board must not be zealous to find an applicant not to be credible and "must not be over-vigilant in its microscopic examination of the evidence of persons who testify through interpreters and tell tales of horror in whose objective reality there is reason to believe.

#### 356:1:subtheme:6 · paragraphs 25-30

- Raw key terms: `applicant, tribunal, example, find, applicant's, claim, consider, contradictions`
- Display key terms: `example, find, applicant's, consider, contradictions`
- Argument roles: `evidence_fact, issue, reasoning_application`
- Explanation: Observed roles: evidence_fact, issue, reasoning_application Display terms: example, find, applicant's, consider, contradictions Application context: [25] These cases as applied by the Federal Court of Appeal itself and by this Court proscribe credibility findings arrived at by, for example: § Findings for which there was no evidence; § Findings of the tribunal based  | [26] The overall impression I have of the tribunal's decision is that it was impermissibly overzealous in seeking to find the applicant not credible leading it to fail to consider the substance of his claim which was his Evidence spans paragraphs 25-30. This is a deterministic evidence summary, not a legal conclusion.
- Evidence: `issue` cue `question` at chunk `4094427` offsets `667-675`; context: Any such inconsistencies should be major and not minor and sufficient by itself to call into question the applicant's credibility.
- Evidence: `evidence_fact` cue `evidence` at chunk `4094427` offsets `177-185`; context: [25] These cases as applied by the Federal Court of Appeal itself and by this Court proscribe credibility findings arrived at by, for example:
...
§ Inconsistencies drawn between POE notes and an applicant's testimony or the applicant's PIF where a tribunal dwells on details and not on the substance of the claim and leads to misconstruction of the evidence.
- Evidence: `reasoning_application` cue `applied` at chunk `4094427` offsets `20-27`; context: [25] These cases as applied by the Federal Court of Appeal itself and by this Court proscribe credibility findings arrived at by, for example:
§ Findings for which there was no evidence;
§ Findings of the tribunal based on conjecture, resulting in unjustified and unsupported inferences regarding the circumstances leading to an application for refugee status;
§ Inconsistencies drawn between POE notes and an applicant's testimony or the applicant's PIF where a tribunal dwells on details and not on the substance of the claim and leads to misconstruction of the evidence.
- Evidence: `reasoning_application` cue `because` at chunk `4094428` offsets `253-260`; context: [26] The overall impression I have of the tribunal's decision is that it was impermissibly overzealous in seeking to find the applicant not credible leading it to fail to consider the substance of his claim which was his fear of returning to Bangladesh because of the death threat he had received from political opponents of the Awami League in his district which is headed by an elected representative of the BNP who was also apparently a Cabinet Minister and was supported in his endeavours by his close associate Monir Hajee with the collaboration of the police who were looking for him.
- Evidence: `reasoning_application` cue `I find` at chunk `4094429` offsets `5-11`; context: [27] I find this zeal led the tribunal to demean the applicant's explanations.
- Evidence: `evidence_fact` cue `evidence` at chunk `4094430` offsets `73-81`; context: [28] I find the tribunal's zeal led it not to consider or weigh material evidence and pushed it to reach unjustifiable conclusions not supported by the evidence, for example:
1.
- Evidence: `reasoning_application` cue `I find` at chunk `4094430` offsets `5-11`; context: [28] I find the tribunal's zeal led it not to consider or weigh material evidence and pushed it to reach unjustifiable conclusions not supported by the evidence, for example:
1.
- Evidence: `evidence_fact` cue `testimony` at chunk `4094431` offsets `64-73`; context: [29] As to terms of the contradictions between his POE, PIF and testimony, the basis for drawing many of these contradictions stemmed from the fact that in his POE, in respect to each position in each of the three organizations between relevant dates and each position, the applicant had written, for example, "member/Publicity Secretary" as the start date.

#### Section text

Jamil v. Canada (Minister of Citizenship and Immigration)
Court (s) Database
...
[29] As to terms of the contradictions between his POE, PIF and testimony, the basis for drawing many of these contradictions stemmed from the fact that in his POE, in respect to each position in each of the three organizations between relevant dates and each 

[Section text truncated at 20000 characters; full text and hashes remain in JSON.]


## 356:2 · paragraphs 31-43

- Citations: `{}`
- Statutes: `{}`
- Tags: `{}`
- Source hash: `34fdaacabab89b984a6a4c15818fabf965fb354807b3f677ec9da10db6d25ed8`

### Deterministic evidence spans

These are finer rule-based clusters inside the broader deterministic unit. Their explanations describe detected cues and roles; they are not model-generated conclusions.

#### 356:2:subtheme:1 · paragraphs 31-36

- Raw key terms: `tribunal, league, tribunal's, applicant, arrest, awami, contradictions, evidence`
- Display key terms: `league, tribunal's, arrest, awami, contradictions`
- Argument roles: `evidence_fact, reasoning_application`
- Explanation: Observed roles: evidence_fact, reasoning_application Display terms: league, tribunal's, arrest, awami, contradictions Application context: [36] I find the tribunal's treatment of the letters unreasonable in that the tribunal has misread the evidence, mischaracterized the nature of his fear and ignored evidence favourable to him. Evidence spans paragraphs 31-36. This is a deterministic evidence summary, not a legal conclusion.
- Evidence: `evidence_fact` cue `testimony` at chunk `4094433` offsets `62-71`; context: [31] The tribunal failed to take into account the applicant's testimony that what he had written in his PIF and what the documentary evidenced showed (Exhibits P-12 and P-15) is he first became an ordinary member in those organizations and sometime later was nominated or elected to the positions he described.
- Evidence: `evidence_fact` cue `evidence` at chunk `4094435` offsets `118-126`; context: [33] I should add counsel for the respondent made a valued attempt to embellish the tribunal's reasons by pointing to evidence not relied upon by the decision-maker to the effect the applicant had lied about the time when he had been a student.
- Evidence: `evidence_fact` cue `Record` at chunk `4094436` offsets `328-334`; context: He had written about his arrest in his PIF (where he said he had been mistreated) and in his POE (see certified Tribunal Record, (CTR) pages 25 and 125).
- Evidence: `evidence_fact` cue `evidence` at chunk `4094438` offsets `102-110`; context: [36] I find the tribunal's treatment of the letters unreasonable in that the tribunal has misread the evidence, mischaracterized the nature of his fear and ignored evidence favourable to him.
- Evidence: `reasoning_application` cue `I find` at chunk `4094438` offsets `5-11`; context: [36] I find the tribunal's treatment of the letters unreasonable in that the tribunal has misread the evidence, mischaracterized the nature of his fear and ignored evidence favourable to him.

#### 356:2:subtheme:2 · paragraphs 37-38

- Raw key terms: `past, applicant, applicant's, arrest, arrested, awami, current, currently`
- Display key terms: `past, applicant's, arrest, arrested, awami, current, currently`
- Argument roles: `issue`
- Explanation: Observed roles: issue Display terms: past, applicant's, arrest, arrested, awami, current, currently Evidence spans paragraphs 37-38. This is a deterministic evidence summary, not a legal conclusion.
- Evidence: `issue` cue `whether` at chunk `4094439` offsets `105-112`; context: [37] In terms of the lawyer's letter, it was not the purpose of his inquiry with the police to determine whether the applicant had been arrested in the past, but rather whether and why the police were currently looking for him.
- Evidence: `issue` cue `issue` at chunk `4094440` offsets `281-286`; context: Moreover, it seems odd that the tribunal would give the Awami League letters some weight on the detention issue but give it no weight generally.

#### 356:2:subtheme:3 · paragraphs 39-43

- Raw key terms: `applicant, tribunal, because, testimony, activities, applicant's, april, august`
- Display key terms: `because, testimony, activities, applicant's, april, august`
- Argument roles: `evidence_fact, issue, reasoning_application`
- Explanation: Observed roles: evidence_fact, issue, reasoning_application Display terms: because, testimony, activities, applicant's, april, august Application context: Answer: Police, I did not have any problem with the police because police never searched for me like that, but they arrested me once. | The applicant had explained it was because during this incident the BNP Goons threatened to kill him. Evidence spans paragraphs 39-43. This is a deterministic evidence summary, not a legal conclusion.
- Evidence: `issue` cue `Question` at chunk `4094441` offsets `316-324`; context: Question: So, you never had any problem with the police before the 25th of August 2004?
- Evidence: `reasoning_application` cue `because` at chunk `4094441` offsets `463-470`; context: Answer: Police, I did not have any problem with the police because police never searched for me like that, but they arrested me once.
- Evidence: `evidence_fact` cue `testimony` at chunk `4094442` offsets `225-234`; context: [40] Counsel for the applicant conceded this contradiction could stand and the tribunal was entitled to reject his explanation but, in my view, the extract does not support the tribunal's inference the applicant adjusted his testimony.
- Evidence: `evidence_fact` cue `testimony` at chunk `4094443` offsets `43-52`; context: [41] The tribunal rejected the applicant's testimony why he had not fled Bangladesh before the August, 2004 attack.
- Evidence: `reasoning_application` cue `because` at chunk `4094443` offsets `151-158`; context: The applicant had explained it was because during this incident the BNP Goons threatened to kill him.
- Evidence: `evidence_fact` cue `testimony` at chunk `4094445` offsets `31-40`; context: [43] Moreover, the applicant's testimony was reasonable in terms of the political strife in Bangladesh.
- Evidence: `reasoning_application` cue `because` at chunk `4094445` offsets `216-223`; context: At page 160 of the CTR, the applicant stated as follows:
"The reason why I didn't think that was so severe it's because I was not threatened to be killed that time.
...
## 356:3 · paragraphs 44-46

- Citations: `{}`
- Statutes: `{}`
- Tags: `{}`
- Source hash: `2db4b4e08eb1fa81242746c3021dddf63c2882c659c28e3420bf1d6884954c27`

### Deterministic evidence spans

These are finer rule-based clusters inside the broader deterministic unit. Their explanations describe detected cues and roles; they are not model-generated conclusions.

#### 356:3:subtheme:1 · paragraphs 44-46

- Raw key terms: `because, previously, able, activists, activities, addition, afraid, allegedly`
- Display key terms: `because, previously, able, activists, activities, addition, afraid, allegedly`
- Argument roles: `evidence_fact, issue, reasoning_application`
- Explanation: Observed roles: evidence_fact, issue, reasoning_application Display terms: because, previously, able, activists, activities, addition, afraid, allegedly Application context: [44] Previously, at page 158 of the CTR the applicant had explained: "No, I was not afraid because things like this happen often in our country and we have to continue our political activities going through these kinds o | [45] Finally, of the treatment of the lawyer's letter, I find, once again, the tribunal misread the evidence. Evidence spans paragraphs 44-46. This is a deterministic evidence summary, not a legal conclusion.
- Evidence: `reasoning_application` cue `because` at chunk `4094446` offsets `91-98`; context: [44] Previously, at page 158 of the CTR the applicant had explained:
"No, I was not afraid because things like this happen often in our country and we have to continue our political activities going through these kinds of things.
- Evidence: `issue` cue `question` at chunk `4094447` offsets `405-413`; context: Yet it had previously given some weight to that letter on the detention question.
- Evidence: `evidence_fact` cue `evidence` at chunk `4094447` offsets `100-108`; context: [45] Finally, of the treatment of the lawyer's letter, I find, once again, the tribunal misread the evidence.
- Evidence: `reasoning_application` cue `I find` at chunk `4094447` offsets `55-61`; context: [45] Finally, of the treatment of the lawyer's letter, I find, once again, the tribunal misread the evidence.
...
## 356:4 · paragraphs 47-48

- Citations: `{}`
- Statutes: `{}`
- Tags: `{}`
- Source hash: `8ee59af2c728294d8ea07e1ee55b763cf4159e253d1b21cfdf007d14c4f6670a`

### Deterministic evidence spans

These are finer rule-based clusters inside the broader deterministic unit. Their explanations describe detected cues and roles; they are not model-generated conclusions.

#### 356:4:subtheme:1 · paragraphs 47-48

- Raw key terms: `allowed, applicant's, arises, aside, cause, certified, claim, constituted`
- Display key terms: `allowed, applicant's, arises, aside, certified, constituted`
- Argument roles: `none`
- Explanation: Observed roles: no explicit argument role cue Display terms: allowed, applicant's, arises, aside, certified, constituted No explicit argument evidence was detected in this span; review it as metadata or cue-free text Evidence spans paragraphs 47-48. This is a deterministic evidence summary, not a legal conclusion.
...
## 356:5 · paragraphs 49-49

- Citations: `{}`
- Statutes: `{}`
- Tags: `{}`
- Source hash: `34fa03297931d0a511cbd48b82ec6a7ca1622592c649739d1deb26c8a5b337f5`

### Deterministic evidence spans

These are finer rule-based clusters inside the broader deterministic unit. Their explanations describe detected cues and roles; they are not model-generated conclusions.

#### 356:5:subtheme:1 · paragraphs 49-49

- Raw key terms: `appearances, applicant, attorney, canada, dated, deputy, diane, doray`
- Display key terms: `dated, deputy, diane, doray`
- Argument roles: `none`
- Explanation: Observed roles: no explicit argument role cue Display terms: dated, deputy, diane, doray No explicit argument evidence was detected in this span; review it as metadata or cue-free text Evidence spans paragraphs 49-49. This is a deterministic evidence summary, not a legal conclusion.

#### Section text

ORDER: The Hon. Justice Lemieux
DATED: June 21, 2006
APPEARANCES:
Me Pia Zambelli
FOR THE APPLICANT
